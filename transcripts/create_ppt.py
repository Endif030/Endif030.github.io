...
family_jokes = [
    ...
    },
    {
        "id": "1.2", 
        "title": "Kevin家的健康争吵",
        "text": "当你还是个孩子的时候，你不会意识到你的家庭 messed up，因为那就是你所知道的一切。但然后会有一个时刻，你意识到一切都不太对劲。对我来说，那是七年级。我在朋友 Kevin 家过夜，Kevin 的爸爸走进客厅说：嘿，今晚谁想看《加勒比海盗》？然后 Kevin 的妈妈跑进来，说：绝对不行，那对他们来说太成熟了。Kevin 爸爸说：但我真的很想看《加勒比海盗》。Kevin 妈妈说：我想你会没事的 Kirk。然后 Kevin 说：我很抱歉让你看到这一幕。那是我听过的最健康的争吵（healthiest disagreement）。"
    },
    {
        "id": "1.3",
        "title": "父母7天大离婚",
    ...
    },
    {
        "id": "1.8",
        "title": "给继父的婚姻建议",
        "text": "我记得有一次在高中，我继父开车送我。他们肯定刚吵过架什么的，因为他问我：我怎么才能让你妈妈开心？但在那个年龄，我对女人的唯一了解来自互联网。所以我说：我不知道。你试过用舌头拼字母表吗（spelling the alphabet with your tongue）？我延长了那段婚姻六年。"
    },
    {
        "id": "1.9",
        "title": "妈妈在eHarmony",
...
for slide_idx in range(0, len(family_jokes), jokes_per_slide):
    ...
    for i, joke in enumerate(family_jokes[slide_idx:slide_idx + jokes_per_slide]):
        ...
        # 添加内容文本
        content_box = slide.shapes.add_textbox(Inches(0.7), Inches(y_pos + 0.6), Inches(11.9), Inches(2.3))
    ...
    if slide_idx + jokes_per_slide < len(family_jokes):
        next_box = slide.shapes.add_textbox(Inches(5.5), Inches(7.0), Inches(2.333), Inches(0.4))
...
# 保存PPT
ppt_path = '/root/.openclaw/workspace/transcripts/Thief_of_Joy_原生家庭_PPT.pptx'
prs.save(ppt_path)
